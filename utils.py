...
def preprocess_training_data(jsonFilePath, stop_words):
    ...
    clean_df.to_csv("save_data.csv")
    return clean_df

def get_scrap_train_data(searchString):
    ...
    for x in review:
        ...
        lis.append(dic)
    findic["data"] = lis
    findic["userId"] = "flipkart"
    findic["projectId"] = searchString
    path = (r"./")
    with open(path + '/train.json', 'w', encoding='utf-8') as f:
        json.dump(findic, f, ensure_ascii=False, indent=4)